...
async function HomePage() {
  return (
    <>
      ...
      <section className="flex flex-col justify-between items-center mt-3 p-5">
        <article className="flex flex-wrap justify-between items-center p-10">
          <Link title="Go to the NextJs" href="https://nextjs.org">
            <svg
          ...
          <h2 className="text-2xl font-semi-bold ml-5">
            the React Framework.
          </h2>
        </article>
        <article className="flex flex-wrap justify-between items-center p-10">
          ...
          >
            ...
            <span className="text-black text-center font-bold">VERCEL</span>
          </Link>
          <h2 className="text-2xl font-semi-bold ml-5">
            Frontend Cloud; most secure and faster web
          </h2>
        </article>
      </section>
